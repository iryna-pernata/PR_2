...
class TransactionAnalyzerTest {
    ...
    public void testFindTopExpenses() {
        ...
        Transaction transaction3 = new Transaction("2023-01-03", -50.0, "Витрата 3");
        List<Transaction> transactions = Arrays.asList(transaction1, transaction2, transaction3);

        List<Transaction> topExpenses = TransactionAnalyzer.findTopExpenses(transactions);

        Assertions.assertEquals(3, topExpenses.size(), "Кількість витрат неправильна.");
        Assertions.assertEquals(transaction2, topExpenses.get(0), "Найбільша витрата повинна бути першою.");
    }
}
